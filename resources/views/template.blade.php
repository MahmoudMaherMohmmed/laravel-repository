                ...
                <ul class="nav nav-list">
                    ...
                    <ul class="nav nav-list">
                        <li id="kannel">
                            <a href="#" class="dropdown-toggle">
                                <i class="glyphicon glyphicon-sound-stereo"></i>
                                <span>@lang('messages.kannel.kannels')</span>
                                <b class="arrow fa fa-angle-right"></b>
                            </a>
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="kannel-index"><a href="{{url('kannel')}}">@lang('messages.kannel.kannels')</a></li>
                                <li id="kannel-create"><a href="{{url('kannel/create')}}">@lang('messages.kannel.create')</a></li>
                                <li id="kannel-status"><a href="{{url('kannels/status')}}">@lang('messages.kannel.kannel_status')</a></li>
                                <li id="kannel-logs"><a href="{{url('kannel/logs/show')}}">@lang('messages.kannel.logs')</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
