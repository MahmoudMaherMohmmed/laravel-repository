...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2021 at 12:53 PM
...
--
-- Table structure for table `kannels`
--

CREATE TABLE `kannels` (
...
--
-- Dumping data for table `kannels`
--

INSERT INTO `kannels` (`id`, `title`, `url`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Orange', 'http://10.2.10.25:20000/status.xml', 1, '2021-08-29 07:20:09', '2021-08-29 07:20:09'),
(2, 'Etisalat', 'http://10.2.10.40:20000/status.xml', 1, '2021-08-29 07:20:09', '2021-08-29 07:20:09');

-- --------------------------------------------------------

--
-- Table structure for table `kannel_logs`
--

CREATE TABLE `kannel_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kannel_id` bigint(20) UNSIGNED NOT NULL,
  `connection_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `port` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sent` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `queued` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `failed` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `throughput` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `kannel_logs`
--

INSERT INTO `kannel_logs` (`id`, `kannel_id`, `connection_name`, `ip`, `port`, `status`, `sent`, `queued`, `failed`, `throughput`, `created_at`, `updated_at`) VALUES
(1, 1, 'HANDSET', '10.240.22.189', '9090', 'running, uptime 0d 3h 12m 25s', '924828', '0', '0', '81', '2021-08-29 07:21:41', '2021-08-29 07:21:41'),
(2, 2, 'ivasrbt', '10.71.80.7', '11020', 'running, uptime 0d 2h 24m 17s', '794368', '105586', '0', '92', '2021-08-29 07:21:42', '2021-08-29 07:21:42');
...
(1, 'Arabic', '2019-02-11 11:12:04', '2019-02-11 11:12:04', 'ar', 1),
(2, 'English', '2019-02-11 11:12:04', '2019-02-11 11:12:04', 'en', 0);
...
(6, '2017_08_01_141233_create_permission_tables', 1),
(7, '2019_04_22_161443_create_categories_table', 1),
(8, '2019_04_22_161443_create_content_types_table', 1),
(9, '2019_04_22_161443_create_contents_table', 1),
(10, '2019_04_22_161443_create_countries_table', 1),
(11, '2019_04_22_161443_create_delete_all_flags_table', 1),
(12, '2019_04_22_161443_create_languages_table', 1),
(13, '2019_04_22_161443_create_operators_table', 1),
(14, '2019_04_22_161443_create_password_resets_table', 1),
(15, '2019_04_22_161443_create_permissions_table', 1),
(16, '2019_04_22_161443_create_posts_table', 1),
(17, '2019_04_22_161443_create_rbt_codes_table', 1),
(18, '2019_04_22_161443_create_relations_table', 1),
(19, '2019_04_22_161443_create_role_has_permissions_table', 1),
(20, '2019_04_22_161443_create_role_route_table', 1),
(21, '2019_04_22_161443_create_roles_table', 1),
(22, '2019_04_22_161443_create_routes_table', 1),
(23, '2019_04_22_161443_create_scaffoldinterfaces_table', 1),
(24, '2019_04_22_161443_create_settings_table', 1),
(25, '2019_04_22_161443_create_static_bodies_table', 1),
(26, '2019_04_22_161443_create_static_translations_table', 1),
(27, '2019_04_22_161443_create_tans_bodies_table', 1),
(28, '2019_04_22_161443_create_translatables_table', 1),
(29, '2019_04_22_161443_create_types_table', 1),
(30, '2019_04_22_161443_create_user_has_permissions_table', 1),
(31, '2019_04_22_161443_create_user_has_roles_table', 1),
(32, '2019_04_22_161443_create_users_table', 1),
(33, '2019_04_22_161445_add_foreign_keys_to_categories_table', 1),
(34, '2019_04_22_161445_add_foreign_keys_to_contents_table', 1),
(35, '2019_04_22_161445_add_foreign_keys_to_delete_all_flags_table', 1),
(36, '2019_04_22_161445_add_foreign_keys_to_operators_table', 1),
(37, '2019_04_22_161445_add_foreign_keys_to_posts_table', 1),
(38, '2019_04_22_161445_add_foreign_keys_to_rbt_codes_table', 1),
(39, '2019_04_22_161445_add_foreign_keys_to_relations_table', 1),
(40, '2019_04_22_161445_add_foreign_keys_to_role_has_permissions_table', 1),
(41, '2019_04_22_161445_add_foreign_keys_to_role_route_table', 1),
(42, '2019_04_22_161445_add_foreign_keys_to_settings_table', 1),
(43, '2019_04_22_161445_add_foreign_keys_to_static_bodies_table', 1),
(44, '2019_04_22_161445_add_foreign_keys_to_tans_bodies_table', 1),
(45, '2019_04_22_161445_add_foreign_keys_to_user_has_permissions_table', 1),
(46, '2019_04_22_161445_add_foreign_keys_to_user_has_roles_table', 1),
(47, '2019_12_30_091104_create_providers_table', 1),
(48, '2019_12_30_161445_add_foreign_keys_to_categoriesproviders_table', 1),
(49, '2020_01_01_082734_add_provider_id_Rbtcodes_table', 1),
(50, '2020_01_22_091056_rename_routes_route', 1),
(51, '2021_08_26_094735_create_kannels_table', 2),
(52, '2021_08_26_095439_insert_data_to_kannels_table', 2),
(53, '2021_08_26_100417_create_kannel_logs_table', 2),
(54, '2021_08_26_101439_add_foreign_key_to_kannel_logs_table', 2);
...
(172, 'get', 'all_routes/{id}/edit', 'RouteController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'edit'),
(173, 'get', 'all_routes/{id}/delete', 'RouteController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'destroy'),
(174, 'post', 'all_routes/{id}/update', 'RouteController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'update'),
(175, 'get', 'content/allData', 'ContentController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'allData'),
(176, 'get', 'category/allData', 'CategoryController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'allData'),
(177, 'get', 'post/allData', 'PostController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'allData'),
(178, 'get', 'rbt/allData', 'RbtController', '2019-02-14 11:01:13', '2019-02-14 11:01:13', 'allData');
...
(1, 'super admin', 'super_admin@ivas.com', '$2y$10$u2evAW530miwgUb2jcXkTuqIGswxnSQ3DSmX1Ji5rtO3Tx.MtVcX2', '', '01234567890', 'aFjryZQ6Okw7FeJm7QJjqXxVG5TageNTE1sooxyeLhU3LRCEBLT85Oy8cBWJ', '2017-11-09 04:13:14', '2018-11-26 06:11:50');
...
--
-- Indexes for table `kannels`
--
ALTER TABLE `kannels`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kannel_logs`
--
ALTER TABLE `kannel_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kannel_logs_kannel_id_foreign` (`kannel_id`);
...
--
-- AUTO_INCREMENT for table `kannels`
--
ALTER TABLE `kannels`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `kannel_logs`
--
ALTER TABLE `kannel_logs`
...
--
-- Constraints for table `kannel_logs`
--
ALTER TABLE `kannel_logs`
  ADD CONSTRAINT `kannel_logs_kannel_id_foreign` FOREIGN KEY (`kannel_id`) REFERENCES `kannels` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
